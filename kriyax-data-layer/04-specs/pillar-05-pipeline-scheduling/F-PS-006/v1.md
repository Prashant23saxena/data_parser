# Spec — F-PS-006: Enable/disable pipeline

**Version:** v1  
**Status:** FROZEN  
**Last updated:** 2026-05-02  
**Pillar:** pillar-05-pipeline-scheduling  
**Feature ref:** `03-features/pillar-05-pipeline-scheduling/current.md` → F-PS-006  
...
Pause or resume scheduled execution without deleting pipeline configuration.
...
| enabled | boolean | yes | true | target state |
...
- Disabled pipelines skip schedule.
- Manual trigger remains available.
- Re-enable resumes schedule and recalculates next run.

## Side effects on success

- Updates pipeline enabled flag.
...
- [ ] Disable pipeline stops scheduled runs.
- [ ] Manual run still works while disabled.
- [ ] Re-enable restores next run.
- [ ] Status visible in pipeline list.
